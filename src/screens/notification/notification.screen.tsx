...
import { NotificationsData } from "@/src/configs/constants";
import moment from "moment";
import { setAuthorizationHeader } from "@/src/hooks/fetch/useUser";
    ...
    >
      ...
      >
        ...
        <View style={{ width: scale(265) }}>
          ...
          >
            {/* {moment(item.createdAt).fromNow()} */}1 days ago
          </Text>
        </View>
      </Pressable>
    </Swipeable>
    ...
    >
      ...
      >
        <Pressable
          ...
          <Text style={{color:theme.dark?"#fff":"#000",textAlign:"center",width:scale(220)}}>Notifications</Text>
      </View>
    </View>
