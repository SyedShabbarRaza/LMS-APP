...
import useUser, { setAuthorizationHeader } from "@/src/hooks/fetch/useUser";
import axios from "axios";
const customerSupport = require("../../../assets/images/adobe.png");
    ...
    >
      ...
      >
        <Pressable
          ...
          onPress={() => router.back()}
        >
          <AntDesign name="arrow-left" size={scale(22)} color="black" />
        </Pressable>
...
/>
      ...
      <View style={{ padding: scale(20) }}>
        ...
        <Pressable
          ...
          onPress={() => Linking.openURL("mailto:syedshabbarraza208@gmal.com")}
        >
          <IconThree />
          <View>
            <Text
